...
class _WeeklyViewState extends State<WeeklyView> {
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        return Consumer<BujoProvider>(
          builder: (context, provider, _) {
            ...
            if (weeklyBullets.isEmpty && !isHovering) {
  ...
  Widget _buildDraggableItem(BuildContext context, BujoProvider provider, Bullet bullet, {bool isPool = false}) {
    ...
    Widget slidableItem = Slidable(
      ...
      startActionPane: (bullet.type == 'task') ? _buildStartPane(context, provider, bullet) : null,
      endActionPane: _buildEndPane(context, provider, bullet),
  ...
  ActionPane _buildStartPane(BuildContext context, BujoProvider provider, Bullet b) {
    return ActionPane(
  ...
  ActionPane _buildEndPane(BuildContext context, BujoProvider provider, Bullet b) {
    return ActionPane(
      motion: const ScrollMotion(),
      children: [
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: bullet.type == 'task' ? () => provider.toggleStatus(bullet.id) : null,
                child: Container(
